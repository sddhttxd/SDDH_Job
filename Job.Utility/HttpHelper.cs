...
namespace Job.Utility
{
    public class HttpHelper
    {
        ...
        /// <param name="timeOut">超时值：以毫秒为单位</param>
        /// <returns></returns>
        public static string HttpGet(string strURL, int timeOut, Encoding encode)
        {
        ...
        /// <param name="timeOut">超时值：以毫秒为单位</param>
        /// <returns></returns>
        public static string HttpPost(string strURL, string strParm, int timeOut, Encoding encode)
        {
            StringBuilder rStr = new StringBuilder();
            HttpWebRequest request = null;
            HttpWebResponse response = null;
